...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/two.jpg",
			"assets/images/DesktopWallpaper/three.jpg",
			"assets/images/DesktopWallpaper/four.jpg",
			"assets/images/DesktopWallpaper/five.jpg",
			"assets/images/DesktopWallpaper/e.jpg",
			"assets/images/DesktopWallpaper/six.jpg",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/baby.png",
			"assets/images/MobileWallpaper/cats.png",
			"assets/images/MobileWallpaper/wolf.png",
			"assets/images/MobileWallpaper/mirror.png",
			"assets/images/MobileWallpaper/fancy.png",
